...
const PaymentList: React.FC = () => {
  ...
  const { data: paymentsResponse, isLoading, error, refetch } = PaymentApi.useGetAllPaymentsQuery({
    page: currentPage,
    limit: itemsPerPage,
    search: searchTerm,
    ...filters
  ...
  const totalPages = paymentsResponse?.pagination?.totalPages || 1
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search transaction codes, customer names, booking IDs..."
