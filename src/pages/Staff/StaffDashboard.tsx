...
import AdminDashboardLayout from '../../dashboardDesign/StaffDashbordsidebar.tsx'
        ...
        <AdminDashboardLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="flex items-center">
                        <div className="flex-1">
                            <p className="text-gray-600 text-sm font-medium">Vehicle Fleet</p>
                            <p className="text-2xl font-bold text-gray-900">{stats.totalVehicles}</p>
                            <p className="text-green-600 text-sm mt-1 flex items-center">
                            ...
                            {popularModels.slice(0, 3).map((model) => (
                                <div key={model.model_id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div className="text-right">
                                        <p className="font-semibold text-green-700">{formatCurrency(model.total_revenue)}</p>
                        ...
                        {branchPerformance.slice(0, 4).map((branch) => (
                            <div key={branch.branch_id} className="flex items-center justify-between p-3 border rounded-lg">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-green-700 text-sm">{formatCurrency(branch.total_revenue)}</p>
                                </div>
                            </div>
                        ))}
